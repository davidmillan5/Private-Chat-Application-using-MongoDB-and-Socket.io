...
const dbname = 'Real_Time_Chat_Application';
...
const port = 5000;
const database = 'mongodb+srv://cmillan:wmE7VAUHLBQhs2YG@cluster0.vs4hkru.mongodb.net/Real_Time_Chat_Application?retryWrites=true&w=majority';
const app = express();
